...
- **[🧾 Notebook – AI Foundry Basics (Pre‑built Evaluations)](lab-01-foundry-prebuilt-evaluations.ipynb)**  
  In this lab you’ll:
...
- **[🧾 Notebook – Search Evaluations (Upload & Analyze)](02-search-evaluations-upload-analyze.ipynb)**  
  ...
  - Register your search evaluators in Azure AI Foundry using AI Foundry's Promptflow Package
  - Use AI Foundry to determine best-indexer configuration for the dataset
...
- **[🧾 Notebook – Repeatable Evaluations & CI/CD](lab-03-repeatable-evaluations-ci-cd.ipynb)**  
  ...
  - Learn how to configure GitHub Actions to catch metric drift in CI/CD  
